...
public class PreviewDialog extends javax.swing.JFrame {
  String nama,  kelas, jk,alamat,  jurusan;
    /**
     * Creates new form PreviewDialog
     */
    public PreviewDialog(String nama,String kelas, String jk,String alamat, String jurusan) {
        initComponents();
        Biodata mhs = new Biodata(nama, kelas, jk, alamat, jurusan);
        txtNama.setText(mhs.getNama());
        txtKelas.setText(mhs.getKelas());
        txtJk.setText(mhs.getJk());
    ...
    private void initComponents() {
        ...
        txtJk.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        ...
        txtJurusan.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        txtJurusan.setForeground(new java.awt.Color(255, 255, 255));
        txtJurusan.setText("Jurusan :");

        btnkeluar.setForeground(new java.awt.Color(204, 0, 51));
